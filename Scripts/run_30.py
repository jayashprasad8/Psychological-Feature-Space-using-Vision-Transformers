...
mds_model.save('./Models/mds_30_'+str(num_train_epochs)+'_'+str(train_batch_size)+'_'+str(eval_batch_size)+'_'+str(learning_rate)+'_'+str(weight_decay_rate)+'_'+str(num_warmup_steps)+'_'+str(num_dense_layers)+'_'+'.keras')
...
with open('30rocks_results.txt','a') as f:
