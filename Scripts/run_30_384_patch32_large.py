...
mds_model.save('/N/slate/janandan/Models/mds_30_384_patch32_large_'+str(num_train_epochs)+'_'+str(train_batch_size)+'_'+str(eval_batch_size)+'_'+str(learning_rate)+'_'+str(weight_decay_rate)+'_'+str(num_warmup_steps)+'_'+str(num_dense_layers)+'_'+'.keras')
...
with open('30_rocks_results_384_patch32_large.txt','a') as f:
