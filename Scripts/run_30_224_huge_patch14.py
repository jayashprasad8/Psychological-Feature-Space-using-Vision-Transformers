...
mds_model.save('/N/slate/janandan/Models/new_mds_30_224_huge_patch_14_'+str(num_train_epochs)+'_'+str(train_batch_size)+'_'+str(eval_batch_size)+'_'+str(learning_rate)+'_'+str(weight_decay_rate)+'_'+str(num_warmup_steps)+'_'+str(num_dense_layers)+'_'+'.keras')
...
with open('results_224_huge_patch_14_new.txt','a') as f:
